...
<section class="content-header">
    <div class="box">
        <div class="row">
            ...
            <div class="col-sm-3">
               @if(empty($winner) && $upcoming->tickets->isNotEmpty() && $upcoming->expireDate < $now)
                <a href="{{ url('admin/campaign/announce', [$upcoming->_id]) }}" class="btn btn-create-ad" style="margin-top: 21px; color:white;">
                Announce Winner
                </a>
                @endif
            </div>
...
<section class="content-header">
    <div class="row">
        <div class="col-sm-3">
            ...
            <div class="boxed" style="    padding: 10px;  border-radius: 2px;
                ...
                <img style="max-height: 169px;
                    width: 100%;" class="img-responsive" src="{{ $upcoming->product->productImageUrl ?? 'https://via.placeholder.com/150' }}">
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="boxed" style="  border-radius: 2px;
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <img class="img-responsive" src="{{ $upcoming->campaignUrl ?? 'https://via.placeholder.com/120' }}">
                    </div>
                    <div class="col-sm-7">
                        <h5>{{ strip_tags($upcoming->campaignDesEN) }}</h5>
                        <span></span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-3">
            ...
            <div class="boxed" style="  border-radius: 2px;
                border: solid 1px #53004b;    padding: 10px;">
                <h4><b>AED {{ $upcoming->soldOut }}</b></h4>
                <p>Product price per unit
                    included all tax
                </p>
                <h3 class="text-danger">{{ ($upcoming->isSoldOut == true) ? 'Sold Out' : '' }}</h3>
            </div>
        </div>
    </div>
</section>
